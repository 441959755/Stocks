...
@ccclass
export default class RankItem5 extends cc.Component {
    ...
    onShow(obj, index, awardArr, capital) {
        this._info = obj;
        ...
        if (awardArr) {
            ...
            if (awardArr[0].i == pb.GamePropertyId.Vip) {
                ...
                this.award.node.children[2].active = false;
            }
            ...
            else if (awardArr[0].i == pb.GamePropertyId.RMB) {
                this.award.node.children[1].active = false;
                this.award.node.children[0].active = false;
                this.award.node.children[2].active = true;
        ...
        this.winCount.string = (((obj.cgdsCapital - capital) / capital) * 100).toFixed(2) + '%';

        this.totalCount.string = obj.cgdsCapital;
